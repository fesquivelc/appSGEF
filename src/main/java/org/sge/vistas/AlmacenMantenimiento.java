...
import org.sge.controladores.AlmacenControlador;
import org.sge.entidades.Almacen;
 ...
 * @author RyuujiMD
 */
public class AlmacenMantenimiento extends javax.swing.JInternalFrame {

    /**
     * Creates new form TipoEquipoMantenimiento
     */
    private int accion = 0;
    private final AlmacenControlador almacenControlador;
    private static AlmacenMantenimiento instancia = null;
    private List<Almacen> lista;

    private AlmacenMantenimiento() {
        this.almacenControlador = new AlmacenControlador();
        initComponents();
        initDatosTablaTipoEquipo();
        activarComponentes();
    }

    public static AlmacenMantenimiento getInstancia() {
        if (instancia == null) {
            instancia = new AlmacenMantenimiento();
        }
        return instancia;
    }
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        almacenControlador.prepararCrear();
        activarComponentes();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            if (FormularioUtil.dialogoConfirmar(this, accion)) {
                Almacen almacen = almacenControlador.getSeleccionado();
                FormularioUtil.convertirMayusculas(this.pnlDatos);
                
                BeanUtils.setProperty(almacen, "ruc", txtRUC.getText());
                BeanUtils.setProperty(almacen, "nombre", txtNombre.getText());

                almacenControlador.accion(accion);

                if (accion == AbstractControlador.NUEVO) {
                    lista.add(almacen);
                } else {
                    lista.clear();
                    lista.addAll(almacenControlador.buscarTodos());
                }
            ...
            Logger.getLogger(AlmacenMantenimiento.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (fila != -1) {
            ...
            almacenControlador.setSeleccionado(lista.get(fila));
            activarComponentes();
            mostrarSeleccionado();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        ;
        SeleccionarEmpresa seleccionarEmpresa = new SeleccionarEmpresa(this);        
        this.almacenControlador.getSeleccionado().setEmpresa(seleccionarEmpresa.getEmpresa());
        
        this.txtNombre.setText(this.almacenControlador.getSeleccionado().getEmpresa().getNombre());
    ...
    private void initDatosTablaTipoEquipo() {
        lista = ObservableCollections.observableList(this.almacenControlador.buscarTodos());
    ...
    private void mostrarSeleccionado() {
        try {
            Almacen almacen = almacenControlador.getSeleccionado();
            txtRUC.setText(BeanUtils.getProperty(almacen, "ruc"));
            txtNombre.setText(BeanUtils.getProperty(almacen, "nombre"));
